...
public class PersonalInfoFragment extends BaseBackFragment {
    ...
    public static PersonalInfoFragment newInstance(Bundle bundle,UserBaseInfo userBaseInfo){
        PersonalInfoFragment fragment = new PersonalInfoFragment();
        userBaseInfo = (UserBaseInfo) bundle.getSerializable("userinfo");
        Log.e("传递的个人资料",userBaseInfo.getId()+"");
        bundle.putSerializable("param",userBaseInfo);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        userBaseInfo = (UserBaseInfo) getArguments().getSerializable("userinfo");
        Log.e("传递的个人资料",userBaseInfo.getId()+"");
...
/*
        tv_mine_personalinfo_password.setText(userBaseInfo.getPassword()+"");
*/
    }
}
