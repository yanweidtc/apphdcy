...
public class Demo2Activity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, UVideoView.Callback {
	...
	protected void onCreate(Bundle bundles) {
		...
		mVideoView= (UVideoView) this.findViewById(R.id.videoview);
		mDefinitionRadioGroup= (RadioGroup) this.findViewById(R.id.definition_radio_group);
		mDecoderRadioGroup= (RadioGroup) this.findViewById(R.id.decoder_radio_group);
