...
public class UBottomView extends RelativeLayout{
	...
	protected void onFinishInflate() {
		...
		mPlayPauseButton= (ImageButton) this.findViewById(R.id.img_bt_pause_play);

		mSeekBar= (SeekBar) this.findViewById(R.id.seekbar);

		mFastSeekBar= (SeekBar) this.findViewById(R.id.fast_seekbar);

		mCurrentPositionTxtv= (TextView) this.findViewById(R.id.txtv_current_position);

		mDurationTxtv= (TextView) this.findViewById(R.id.txtv_duration);
		mSeekingIndexTxtv= (TextView) this.findViewById(R.id.fast_seek_index_txtv);

		mSeekIndexView= (ViewGroup) this.findViewById(R.id.fast_seek_index_rl);

		mBrightnessImgBtn= (ImageButton) this.findViewById(R.id.img_btn_brightness);

		mVolumeImgBtn= (ImageButton) this.findViewById(R.id.img_btn_volume);
